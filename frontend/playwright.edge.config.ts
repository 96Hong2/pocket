 ...
 * ## 왜 갈라 뒀나
 *
 경계값·실패 주입·긴 목록이 많아 성격이 다르고, 고장이 나도 "지금 만든 것이 깨졌다" 가
 * 아니라 "원래 이랬다" 인 경우가 많아 리포트를 따로 받는다.
 *
 * **CI 에서는 기본 검증 다음에 이어서 돈다**(2026-09-15). 갈라 두었더니 출시 판에서 한 번도
 * 안 돈 채 나갈 뻔했다. 한 바퀴가 1분 남짓이라 붙여 두는 값이 더 컸다.
 *
