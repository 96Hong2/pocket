...
export const TEST_IDS = {
  ...
  adSlot: 'ad-slot',
  /**
   * 사진·문장을 읽는 동안의 진행 표시 전체.
   *
   * 안의 문구가 시간에 따라 바뀌어서 글자로는 "아직 도는 중" 을 못 잡는다.
   * 첫 문구로 잡으면 문구가 넘어간 순간 끝난 것으로 읽힌다.
   */
  parseProgress: 'parse-progress',
  /** 그 안에서 차오르는 막대. 이름이 없는 그림이라 여기 둔다. */
  parseProgressBar: 'parse-progress-bar',
  /**
   * 기록 시트에서 지금 눌러 둔 금액.
   *
